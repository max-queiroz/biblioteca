...
<nav class="navbar navbar-expand-lg shadow-sm navbar-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.jsp"> <img src="images/logo.png" alt="">Biblioteca</a>
    ...
    <div class="row">
        ...
        <main class="col-12 px-md-4 main-content">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <a class="btn btn-info" href="<%= request.getContextPath() %>/livros/cadastrar">Cadastrar</a>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<%= request.getContextPath() %>/livros/excluir?id=<%= livro.getId() %>" class="btn btn-sm btn-danger">Excluir</a>
                            <a href="<%= request.getContextPath() %>/livros/editar?id=<%= livro.getId() %>" class="btn btn-sm btn-primary">Editar</a>
                        </td>
                    </tr>
                    <% } %>
                    </tbody>
